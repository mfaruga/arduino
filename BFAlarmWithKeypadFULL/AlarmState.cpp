...
void MFAlarm::getStateAsString(String &dest) 
{
  switch (this->state) {
    ...
    case ALARM :
      ...
      break;
    default :
      Serial.print("UNRECOGNIZED SWITCH STATEMENT: getStateAsString");
      dest = "COS NIE TAK, ZAWOLAJ TATE!"; 
  }   
}

ALARM_STATE MFAlarm::getState() 
{ 
  return state; 
}

void MFAlarm::getTimerAsString(String &dest) 
{
  switch (this->state) {
    
    case GOING_OUT :
      dest = String(getTimerGoOutInSeconds());
      break;
    case ENTERING :
      dest = String(getTimerEntryInSeconds());
      break;
    case NOT_ARMED :
    case ARMED :
    case ALARM :
      ...
      break;
    default :
      Serial.print("UNRECOGNIZED SWITCH STATEMENT: getTimerAsString()");
      dest = "  "; 
  }   
}
